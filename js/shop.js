...
(function() {
    ...
    function showBalanceModal() {
        ...
        const modalBalanceEl = document.getElementById('shop-balance-modal-display');
        if (topBalanceEl) topBalanceEl.textContent = `余额: ¥${state.balance.toFixed(2)}`;
        if (modalBalanceEl) modalBalanceEl.textContent = `¥${state.balance.toFixed(2)}`;
        const modal = document.getElementById('shop-balance-modal');
